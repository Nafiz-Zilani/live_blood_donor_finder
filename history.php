...
$query = "SELECT * FROM history WHERE user_id='{$_user_id}'";
    ...
    <div class="main-body">
        <table>
            ...
            <tr>
                ...
                <th width="15%">Doner Name</th>
                <th width="10%">Date</th>
                <th width="50%">Review</th>
                <th width="10%">Rate [*/5]</th>
                <th width="5%">Edit</th>
            </tr>
            </thead>
            <tbody>
            ...
            if (count($data)>0){
                ...
                for ($i=0; $i<$length; $i++){
                    ?>
                    <tr>
                        <td><?php echo $data[$i]['reference'] ?></td>
                        <td><?php echo $data[$i]['doner_name'] ?></td>
