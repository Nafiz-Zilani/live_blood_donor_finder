...
<div class="w3-main" style="margin-left:300px">
    ...
    <div><img src="image/done.png" id="blood_group_chart"></div>
    <h3 style="padding-left: 20px">Send request to user</h3>
    <h4 style="padding-left: 20px; color: firebrick"><a href="dashboard.php">Go Back</a></h4>
