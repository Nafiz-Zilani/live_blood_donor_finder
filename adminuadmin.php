...
<div class="w3-main" style="margin-left:300px">
    <h1 class="maintitle">
        ...
        <br>
        <br>
        <p style="padding-left: 5%">History</p>
    </h1>
    <div class="main-body">
        <table>
            <thead>
        ...
        <div>
            <form id="from01" method="post" action="action.php">
                ...
                <input class="button-primary" type="submit" name="updatebutto" value="Add">
                <input class="button-primary" type="submit" name="updatebutto" value="Del">
                <input type="hidden" name="action" id="action" value="adminupdate">
            </form>
        </div>
    </div>
